        ...
        <Layout classname='pt-0 md:pt-16 sm:pt-8'>
          <div className=' flex items-center justify-between w-full lg:flex-col'>
            ...
            <div className='w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center'>
              ...
              Soy un desarrollador web autodidacta con experiencia. Mi enfoque está en aprender de forma continua y aplicar esos conocimientos en proyectos de forma práctica para ello He trabajado en una variedad de proyectos para mejorar en mi rendimiento y habilidades técnicas.
              </p>
